...
protobuf.load("../types/server_connection.proto", (err, root) => {
    if (err)
        throw err;

    let JoinMessage = root.lookupType("ServerConnection")
    ...
    let payload = {ip_domain: "127.0.0.1", port: 1337, key: testkey}
